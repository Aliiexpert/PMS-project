 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="app">
            {loading ? <div className="flex ps-48 items-center justify-center h-screen w-screen">
                <div className="w-10 h-16  border-4 border-dashed rounded-full animate-spin border-violet-400"></div>
            </div>
                    ...
                    <div className={`className="h-screen  fade-in w-screen flex  justify-end ${showNotification ? 'blurr -z-50' : ''}`}>
                        {isEditModalOpen && (
                            <div className="modal-container  flex items-center justify-center z-100">
                                ...
                                <div className="relative p-8 w-full max-w-md m-auto flex-col flex rounded-lg bg-white opacity-100 text-black">
                                ...
                                <div className="container p-2 sm:p-4 text-black">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className='w-5/6 me-6'>
                                            <div className="overflow-x-auto shadow-md w-9/12 bg-white">
                                    ...
                                    <div className="overflow-x-auto shadow-md mb-10 bg-white  w-9/12 ">
                                        <table className=" w-full text-sm border-collapse">
                                            <colgroup>
                                            </colgroup>
                                            <thead className="bg-white  ">
